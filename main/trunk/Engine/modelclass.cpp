...
bool ModelClass::InitializeInstanced(ID3D11Device* device, char* modelFilename, InstanceType* instances, int numModels)
{
	bool result;
...
bool ModelClass::InitializeOrdinary(ID3D11Device* device, char* modelFilename)
{
	bool result;
...
void ModelClass::CalculateModelVectors()
{
	...
	for(i = 0; i < faceCount; i++)
	{
		...
		vertex1.nx = mModel[index].nx;
		vertex1.ny = mModel[index].ny;
		vertex1.nz = mModel[index].nz;
		index++;
		...
		vertex2.nx = mModel[index].nx;
		vertex2.ny = mModel[index].ny;
		vertex2.nz = mModel[index].nz;
		index++;
		...
		vertex3.nx = mModel[index].nx;
		vertex3.ny = mModel[index].ny;
		vertex3.nz = mModel[index].nz;
		index++;
